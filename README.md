...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fda94jm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fda94jm.containers.anotherwebservice.com/
...
```
git clone git@github.com:profyassir/container-fda94jm.git
cd container-fda94jm
```
...
```
docker attach container-fda94jm
```
